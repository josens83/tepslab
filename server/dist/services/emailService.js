...
exports.getEmailVerificationTemplate = exports.getPaymentConfirmationEmailTemplate = exports.getPasswordResetEmailTemplate = exports.getWelcomeEmailTemplate = exports.sendEmail = void 0;
...
const getPaymentConfirmationEmailTemplate = (name, courseTitle, amount, orderId) => {
    return `
    <!DOCTYPE html>
    <html>
    <head>
...
const getEmailVerificationTemplate = (name, verifyUrl) => {
    return `
    <!DOCTYPE html>
    <html>
    <head>
