...
export class AITutorService {
  private systemPrompt = `You are an expert TEPS (Test of English Proficiency developed by Seoul National University) tutor with deep knowledge of:
...
Keep responses concise but comprehensive.`;
  ...
  async chat(
    ...
    if (context) {
      ...
      if (context.difficulty) contextMessage += `Difficulty: ${context.difficulty}. `;
      if (context.targetScore) contextMessage += `Target Score: ${context.targetScore}. `;
